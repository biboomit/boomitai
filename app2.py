...
if show_client_dropdown:
    ...
    if clientes:
        ...
        prompts_abreviados = {
            'Comparativa de rendimiento entre medios': f"""...""", # Simplificado por claridad
            'Mejor y peor campaña de los últimos 7 días': f"""...""", # Simplificado por claridad
            'Análisis de Variación de CVR': f"""...""" # Simplificado por claridad
        }
        ...
        with col1:
            if st.button("Preguntar a Boomit AI"):
                # Mostrar mensaje de procesamiento y barra de progreso solo después de seleccionar el prompt y hacer clic en el botón
                st.markdown("### Procesando... por favor, espere")
                ...
                # Simula actualizaciones de la barra de progreso durante el análisis
                for percent_complete in range(0, 101, 20):  # Incrementa el progreso en pasos del 20%
                    time.sleep(1)  # Simula el tiempo de procesamiento (ajusta según tu proceso real)
